...
class ManterServicoUI:
    def main():
        ...
        with tab1: ManterServicoUI.servico_inserir()
        with tab2: ManterServicoUI.servico_listar()
        with tab3: ManterServicoUI.servico_atualizar()
        with tab4: ManterServicoUI.servico_excluir()
